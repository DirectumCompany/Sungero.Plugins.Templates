...
7. Подключите серверный плагин к DirectumRX:
    ...
    * При необходимости передачи дополнительных настроек в плагин, их нужно прописать в тех же конфигурационных файлах *_ConfigSettings.xml*, где производилась настройка пути к папке с плагинами. Формат секции с настройками: 
      ```
      <block name="PLUGINS">
